    ...
    >
      ...
      <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <motion.div variants={itemVariants}>
          ...
          {/* Social Links */}
          <div className="mt-6">
            <h4 className="font-medium text-white mb-2 text-sm">Sígueme</h4>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`flex items-center justify-center w-10 h-10 rounded-lg text-white transition-colors ${social.bgClass} ${social.hoverClass} focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50`}
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => handleSocialClick(social.label)}
                  className={`flex items-center justify-center w-11 h-11 rounded-lg text-white transition-colors ${social.bgClass} ${social.hoverClass} focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50`}
                  aria-label={`Seguir en ${social.label}`}
                >
                  <social.icon className="w-5 h-5" aria-hidden="true" />
                </a>
