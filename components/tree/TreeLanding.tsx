      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-sm">
        <header className="text-center mb-6 sm:mb-8" role="banner">
          ...
          >
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-text mb-2">Elkis Daza</h1>
            <p className="text-sm sm:text-base text-text-secondary mb-3">Realtor · Encuentra tu próximo hogar</p>
            <UFIndicator />
          </motion.div>
        </header>

        {/* Opciones más pequeñas y minimalistas */}
        <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8" role="navigation" aria-label="Opciones de servicio">
          <motion.div
            initial={prefersReducedMotion ? false : { opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 id="rent-title" className="text-sm sm:text-base font-semibold text-text leading-relaxed">Quiero arrendar</h2>
              ...
              <CardContent className="p-4 sm:p-5">
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 id="buy-title" className="text-sm sm:text-base font-semibold text-text leading-relaxed">Quiero comprar</h2>
              ...
              <CardContent className="p-4 sm:p-5">
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 id="rent-property-title" className="text-sm sm:text-base font-semibold text-text leading-relaxed">Tengo una propiedad y la quiero arrendar</h2>
          ...
          <motion.div
            initial={prefersReducedMotion ? false : { opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={prefersReducedMotion ? { duration: 0 } : { duration: 0.3, delay: 0.25 }}
          >
            <Card className="rounded-xl border border-border hover:border-brand-aqua/50 dark:hover:border-brand-aqua/40 transition-all duration-200 cursor-pointer group bg-card hover:shadow-md active:scale-[0.98] motion-reduce:active:scale-100">
              <CardContent className="p-4 sm:p-5">
                <button
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 id="sell-title" className="text-sm sm:text-base font-semibold text-text leading-relaxed">Quiero vender mi propiedad</h2>
